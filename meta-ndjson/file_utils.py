...
def find_files(file_data, sampleID, familyID, extension):
	...
	for file in file_data:
		...
		if (sampleID in path or re.sub(r'[a-zA-Z]', '', sampleID) in path or familyID in path) and any(re.search(ext + r'$', path) for ext in extension):
